    ...
    <div class="row">
            ...
            <div id="carouselId" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="{{ asset('/img/phone-img3.png') }}" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('/img/phone-img1.png') }}"  alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('/img/phone-img2.png') }}" alt="Third slide">
                    </div>
                </div>
        ...
        <div class="col-4">
            ...
            <div class="row">
                ...
                <img src="{{ asset('/img/phone-img5.png') }}" class="w-100" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col">
                <table class="table table-borderless table-responsive-lg text-center">
                        ...
                        <tbody class="p-5 img-popular">
                            <tr>
                                <td><img src="{{ asset('img/iPhone.jpg') }}" alt="iPhone"></td>
                                <td><img src="{{ asset('img/Samsung.jpg') }}" alt="samsung"></td>
                                <td><img src="{{ asset('img/OPPO.png') }}" alt="OPPO"></td>
                                <td><img src="{{ asset('img/xiaomi.jpg') }}" alt="iPhone"></td>
                                <td><img src="{{ asset('img/vivo.jpg') }}" alt="iPhone"></td>
                            </tr>
                        </tbody>
                </table>
            </div>
