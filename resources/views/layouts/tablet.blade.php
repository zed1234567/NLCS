    ...
    <div class="row">
            ...
            <div id="carouselId" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="{{ asset('/img/tablet-1.png') }}" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('/img/tablet-2.png') }}"  alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('/img/tablet-3.png') }}" alt="Third slide">
                    </div>
                </div>
        ...
        <div class="col-lg-4 carousel-responsive">
            ...
            <div class="row">
                ...
                <img src="{{ asset('/img/tablet-5.png') }}" class="w-100" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col">
                <table class="table table-borderless table-responsive-lg text-center">
                        ...
                        <tbody class="p-5 img-popular">
                            <tr>
                                <td><img src="{{ asset('img/ipad.jpg') }}" alt="iPhone"></td>
                                <td><img src="{{ asset('img/Samsung.jpg') }}" alt="samsung"></td>
                                <td><img src="{{ asset('img/huawei.jpg') }}" alt="OPPO"></td>
                                <td><img src="{{ asset('img/masstel.png') }}" alt="iPhone"></td>
                ...
                <div class="form-group">
                    <div class="d-flex">
                        <div>
                            ...
                            <button type="button" class="mr-2 btn btn-outline-danger" onclick="window.location.reload()">Xóa Bộ Lọc</button>
                        </div>
                        <div class="d-flex">
